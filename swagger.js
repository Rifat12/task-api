...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "A comprehensive Node.js Express API for task management with file-based JSON storage",
      contact: {
        name: "API Support",
      ...
      schemas: {
        ...
        TaskStatusUpdate: {
          ...
          properties: {
            status: {
              type: "boolean",
              description: "Task completion status (true for completed, false for pending)",
              example: true,
            },
          },
        },
          ...
          content: {
            "application/json": {
              ...
              example: {
                ...
                details: ["Task with ID task_1703123456789_abc123def does not exist"],
              },
            },
          },
        },
